 ...
 */
public class LuceneIndexManagerImpl implements IndexManager, Runnable
{
    ...
    public LuceneIndexManagerImpl(PersistenceManager persistenceManager, String indexDir) throws IOException
    {
