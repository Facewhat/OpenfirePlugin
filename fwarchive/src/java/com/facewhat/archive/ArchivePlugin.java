...
import com.facewhat.archive.manager.ArchiveManager;
import com.facewhat.archive.manager.ArchiveManagerImpl;
import com.facewhat.archive.manager.IndexManager;
import com.facewhat.archive.manager.LuceneIndexManagerImpl;
import com.facewhat.archive.manager.PersistenceManager;
import com.facewhat.archive.manager.PersistenceManagerImpl;
import com.facewhat.archive.util.ArchiveProperties;
import com.facewhat.archive.xep0136.Xep0136Support;
...
public class ArchivePlugin implements Plugin, PacketInterceptor
{
    ...
    public void initializePlugin(PluginManager manager, File pluginDirectory)
    {
        ...
        try
        {
        	...
        	// 可能是用来消息检索时使用的。
            indexManager = new LuceneIndexManagerImpl(persistenceManager, indexDir);
        }
        catch (IOException e)
        {
...
//    		System.out.println("face what archivePlugin :  " + packet.toXML());
//    	}
    	// 是否开启了保存消息功能
        if (!isEnabled()) {
            return;
